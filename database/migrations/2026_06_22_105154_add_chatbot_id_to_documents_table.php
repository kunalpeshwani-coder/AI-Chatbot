...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        // chatbot, so domain_id must become nullable.
        //
        // The SQL is driver-specific because MySQL's MODIFY syntax is not valid
        // on PostgreSQL or SQLite.
        match (Schema::getConnection()->getDriverName()) {
            'pgsql' => DB::statement(
                'ALTER TABLE documents ALTER COLUMN domain_id DROP NOT NULL'
            ),

            'sqlite' => null,

            default => DB::statement(
                'ALTER TABLE documents MODIFY domain_id BIGINT UNSIGNED NULL'
            ),
        };
    ...
    public function down(): void
    {
        ...
        match (Schema::getConnection()->getDriverName()) {
            ...
            default => DB::statement(
                'ALTER TABLE documents MODIFY domain_id BIGINT UNSIGNED NOT NULL'
            ),
        };
    }
};
